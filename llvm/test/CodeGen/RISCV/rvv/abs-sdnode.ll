...
define <vscale x 8 x i8> @vabs_nxv8i8(<vscale x 8 x i8> %v) {
; CHECK-LABEL: vabs_nxv8i8:
; CHECK:       # %bb.0:
...
; CHECK-NEXT:    ret
;
; ZVABD-LABEL: vabs_nxv8i8:
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; ZVABD-NEXT:    vabs.v v8, v8
; ZVABD-NEXT:    ret
  %r = call <vscale x 8 x i8> @llvm.abs.nxv8i8(<vscale x 8 x i8> %v, i1 false)
