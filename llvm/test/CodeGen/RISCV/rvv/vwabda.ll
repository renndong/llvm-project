...
define <vscale x 8 x i16> @vwabda_vx_i8m1(<vscale x 8 x i16> %vd, <vscale x 8 x i8> %vs2, i8 %rs1, iXLen %vl) {
; CHECK-LABEL: vwabda_vx_i8m1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e8, m1, tu, ma
; CHECK-NEXT:    vwabda.vx v8, v10, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 8 x i16> @llvm.riscv.vwabda(<vscale x 8 x i16> %vd, <vscale x 8 x i8> %vs2, i8 %rs1, iXLen %vl, iXLen 0)
  ret <vscale x 8 x i16> %res
}

define <vscale x 4 x i32> @vwabda_vx_mask_i16m1(<vscale x 4 x i32> %vd, <vscale x 4 x i16> %vs2, i16 %rs1, <vscale x 4 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vwabda_vx_mask_i16m1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e16, m1, tu, mu
; CHECK-NEXT:    vwabda.vx v8, v10, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 4 x i32> @llvm.riscv.vwabda.mask(<vscale x 4 x i32> %vd, <vscale x 4 x i16> %vs2, i16 %rs1, <vscale x 4 x i1> %mask, iXLen %vl, iXLen 0)
  ret <vscale x 4 x i32> %res
}
