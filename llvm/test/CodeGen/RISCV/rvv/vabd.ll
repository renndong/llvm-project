...
define <vscale x 2 x i32> @vabd_vx_i32m1(<vscale x 2 x i32> %a, i32 %b, iXLen %vl) {
; CHECK-LABEL: vabd_vx_i32m1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m1, ta, ma
; CHECK-NEXT:    vabd.vx v8, v8, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 2 x i32> @llvm.riscv.vabd(<vscale x 2 x i32> poison, <vscale x 2 x i32> %a, i32 %b, iXLen %vl)
  ret <vscale x 2 x i32> %res
}

define <vscale x 2 x i32> @vabd_vx_mask_i32m1(<vscale x 2 x i32> %passthru, <vscale x 2 x i32> %a, i32 %b, <vscale x 2 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabd_vx_mask_i32m1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m1, ta, mu
; CHECK-NEXT:    vabd.vx v8, v9, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 2 x i32> @llvm.riscv.vabd.mask(<vscale x 2 x i32> %passthru, <vscale x 2 x i32> %a, i32 %b, <vscale x 2 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 2 x i32> %res
}
