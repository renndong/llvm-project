...
# RUN: llvm-mc -triple=riscv32 -filetype=obj --mattr=+v --mattr=+experimental-zvabd %s \
# RUN:        | llvm-objdump -d --mattr=+v --mattr=+experimental-zvabd -M no-aliases - \
# RUN:        | FileCheck %s --check-prefix=CHECK-ALIAS

vabs.v v9, v8
# CHECK-INST: vabs.v v9, v8
# CHECK-ALIAS: vabd.vx v9, v8, zero
...
# CHECK-ALIAS: vabd.vx v9, v8, zero, v0.t
...
vwabda.vv v12, v9, v8
# CHECK-INST: vwabda.vv v12, v9, v8
# CHECK-ENCODING: [0x57,0x06,0x94,0xf6]
# CHECK-ERROR: instruction requires the following: 'Zvabd' (Vector Absolute Difference){{$}}

vwabda.vv v12, v9, v8, v0.t
# CHECK-INST: vwabda.vv v12, v9, v8, v0.t
# CHECK-ENCODING: [0x57,0x06,0x94,0xf4]
# CHECK-ERROR: instruction requires the following: 'Zvabd' (Vector Absolute Difference){{$}}

vwabda.vx v12, v9, a0
# CHECK-INST: vwabda.vx v12, v9, a0
# CHECK-ENCODING: [0x57,0x46,0x95,0xf6]
# CHECK-ERROR: instruction requires the following: 'Zvabd' (Vector Absolute Difference){{$}}

vwabda.vx v12, v9, a0, v0.t
# CHECK-INST: vwabda.vx v12, v9, a0, v0.t
# CHECK-ENCODING: [0x57,0x46,0x95,0xf4]
# CHECK-ERROR: instruction requires the following: 'Zvabd' (Vector Absolute Difference){{$}}

vwabdau.vv v12, v9, v8
# CHECK-INST: vwabdau.vv v12, v9, v8
# CHECK-ENCODING: [0x57,0x06,0x94,0xfa]
# CHECK-ERROR: instruction requires the following: 'Zvabd' (Vector Absolute Difference){{$}}

vwabdau.vv v12, v9, v8, v0.t
# CHECK-INST: vwabdau.vv v12, v9, v8, v0.t
# CHECK-ENCODING: [0x57,0x06,0x94,0xf8]
# CHECK-ERROR: instruction requires the following: 'Zvabd' (Vector Absolute Difference){{$}}

vwabdau.vx v12, v9, a0
# CHECK-INST: vwabdau.vx v12, v9, a0
# CHECK-ENCODING: [0x57,0x46,0x95,0xfa]
# CHECK-ERROR: instruction requires the following: 'Zvabd' (Vector Absolute Difference){{$}}

vwabdau.vx v12, v9, a0, v0.t
# CHECK-INST: vwabdau.vx v12, v9, a0, v0.t
# CHECK-ENCODING: [0x57,0x46,0x95,0xf8]
# CHECK-ERROR: instruction requires the following: 'Zvabd' (Vector Absolute Difference){{$}}
